...
Meta Box Plugin - Basic & Limited Advanced fields export.
Pods - CPT along with All fields export
JetEngine - Basic custom fields export
...
== Changelog ==
= 1.7.7 =
* Added: Export support for JetEngine Metabox - Basic Fields

= 1.7.6 =
* Added: Export support for Meta Box plugin
