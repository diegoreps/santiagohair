...
Import Export All data in WordPress as XML, CSV, or text. All you need is one plugin. 
...
You can [import all types of data from XML and CSV files directly into your WordPress website](https://www.smackcoders.com/documentation/ultimate-csv-importer-pro/how-to-import-csv?utm_source=web&utm_campaign=readme&utm_medium=wp_org) with WP Ultimate CSV Importer Plugin. 
...
1. Browse and Upload your XML or CSV to import 
...
* XML, CSV, TXT format are supported
* Can upload as zip compressed file
* Upload from PC, URL, or FTP/SFTP
* Visitors are notified when maintenance mode is in effect during import
 
= Supported Plugins =
* AIO SEO (free & pro), Rank Math SEO FREE plugin fields import and export.
* WooCommerce - WooCommerce Products are imported along with categories, tags, gallery images, and attributes.
* WooCommerce Product Bundles Plugin fields data import.
...
* Custom Field Suite plugin data import.
* Post Expirator Plugin support.
* WP Job Manager Plugin, imports, and exports job data to Job Listings.
* Meta Box Plugin - Basic & Limited Advanced fields import
* Pods - CPT and All Fields import
* JetEngine - Basic Fields Import
...
* You may need some XML or CSV samples to understand the basics of CSV, [get relevant CSV file](https://www.smackcoders.com/documentation/wp-ultimate-csv-importer-pro/csv-xml-samples?utm_source=web&utm_campaign=readme&utm_medium=wp_org) to try or used to create your own set of CSV file. You can also find sample XML for Import here.
...
* Prepare a XML or CSV file that includes all data
...
* You can add new fields with values to existing posts via a XML or CSV import file.
...
* Learn and improve the XML or CSV import file
...
4. Mapping view of the uploaded XML or CSV fields with WordPress fields.
...
= How to export and import WordPress posts? =

   Under the Export tab, select Posts. Provide a file name and select one file type. Click export and select the Download button to save that file in your local. You can use the exported file as a sample to prepare a new file or import the exported file in another WordPress instance with WP Ultimate CSV Importer to duplicate the data on that website.

   To import posts, upload the prepared CSV or XML file in the 'import/update' section. Then follow the import steps mentioned in the CSV Importer documentation.
...
== Changelog ==
= 6.5.7 =
* Added: Import and Export support for JetEngine Basic Fields
...
= 6.5.5 =
* Added : Import and Export support for Pods plugin

= 6.5.4 =
* Added : Import and Export support for Meta Box plugin
...
= 6.0.7 = 
* Added: Import the post-content image into the media library.
...
* Fixed:  Issue in exporting AllinoneSEO fields.
...
* Added: Post Type import with terms & taxonomies with any depth of the parent-child hierarchy.
...
= 3.5.2 =
* Import posts with author names as numerical apart from the User ID
...
== Upgrade Notice ==
= 6.5.7 =
* Added: Upgrade now to get import and export support for JetEngine basic fields.
= 6.5.6 =
...
= 3.7.4 =
* Upgrade now to allow author/editor to import fix.
= 3.7.3 =
